...
export const API_ERROR_ZH = {
  ...
  TOO_MANY_FILES: '一次上传的文件过多，请分批导入',
  UPLOAD_ERROR: '文件上传失败，请稍后重试',
  BAD_TEMPLATE_PAYLOAD: '导入生成的模板数据校验失败',
  ...
  CONTRACT_STATE_CHANGED: '合同状态已变更，请刷新后重试',
  ...
  INVOICE_AMOUNT_EXCEEDS_APPLICABLE: '开票金额超过可申请余额（已扣除待开票金额）',
  INVOICE_STATE_CHANGED: '开票状态已变更，请刷新后重试',
  INVALID_INVOICE_URL: '发票链接格式不正确，请填写可打开的 http/https 地址',
  ALREADY_SUBMITTED: '已经提交过',
  NOT_SUBMITTED: '尚未提交',
  NO_IDS: '未选择任何记录',
  NOT_IN_REVIEW_QUEUE: '不在待审核队列中',
  COMMENT_REQUIRED: '请填写审核意见或备注',
  URGE_TOO_FREQUENT: '催办过于频繁，请 15 分钟后再试',
  NO_REVIEWER: '当前没有待审批责任人，无法催办',
  CANNOT_URGE_SELF: '您是当前审批人，无需催办自己',
  FILE_REQUIRED: '请上传文件',
  NO_FIELDS_DEFINED: '未配置订单字段，无法导入',
  EMPTY_SHEET: '表格为空或无法读取',
  DUPLICATE_HEADER: '表头重复',
  HEADER_MISMATCH: '表头与模板不一致',
  EXCEL_DUPLICATE_ROWS: 'Excel 中存在多行全字段完全重复的数据',
