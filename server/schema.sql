...
-- 其余内置岗位（总经理/副总/总监/总裁/主管/部门负责人/采购等）由 ensureSchema 启动时 INSERT IGNORE 补齐。
...
CREATE TABLE IF NOT EXISTS qrcodes (
  ...
  qrcode_uid VARCHAR(32) NULL COMMENT '二维码业务编号 QR-年份-序号',
  created_by BIGINT UNSIGNED NULL,
  created_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  PRIMARY KEY (id),
  UNIQUE KEY uk_qrcodes_token (token),
  UNIQUE KEY uk_qrcodes_qrcode_uid (qrcode_uid),
