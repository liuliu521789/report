...
export const RECOMMENDED_TPL_BODY = `<div style="width:100%;margin:0 auto;color:#000;font-family:SimSun,宋体;font-size:14px;line-height:1.7">
<div style="text-align:center;margin-bottom:12px">
  <div style="font-size:44px;letter-spacing:6px;line-height:1.1;font-family:KaiTi,楷体,STKaiti,serif">{{COMPANY_NAME_ZH}}</div>
  <div style="font-size:40px;letter-spacing:14px;line-height:1.2;margin-top:2px;font-family:KaiTi,楷体,STKaiti,serif">销售合同</div>
</div>
<table style="width:100%;border-collapse:collapse;border:none;margin:10px 0 12px 0;font-size:14px;line-height:1.5">
  <tr>
    <td style="border:none;padding:2px 8px 2px 0;width:58%;vertical-align:top">
      <div>买方：{{CUSTOMER_NAME}}</div>
      <div>卖方：{{COMPANY_NAME_ZH}}</div>
    </td>
    <td style="border:none;padding:2px 0 2px 8px;vertical-align:top">
...
<p style="margin:6px 0"><strong>一、产品名称、单价、数量、金额、交货期：</strong></p>
{{ORDER_LINES}}
<p style="margin:6px 0"><strong>二、交货地点、交货期：</strong>买方工厂，运费由卖方承担。</p>
<p style="margin:6px 0"><strong>三、包装标准：</strong>原生产厂家标准包装。</p>
<p style="margin:6px 0"><strong>四、验收标准：</strong>买方按原生产厂家质量标准进行验收。买方可在交货日起三个工作日内对质量提出异议。</p>
<p style="margin:6px 0"><strong>五、结算方式及期限：</strong>电汇或承兑结算，押一批货。</p>
<p style="margin:6px 0"><strong>六、违约责任：</strong>任何一方不履行本合同的任何一项，均属违约。违约方必须赔偿总货款的百分之二十作为违约金。</p>
<p style="margin:6px 0"><strong>七、解决合同纠纷方式：</strong>双方协商解决。如果协商不成，提交卖方办公所在地法院受理。</p>
<p style="margin:6px 0"><strong>八、其他约定事项：</strong>本合同复印件有效但涂改无效。</p>
<table style="width:100%;border-collapse:collapse;border:1px solid #000;margin-top:8px;font-size:14px;line-height:1.5">
  <tr>
    <td style="border:1px solid #000;vertical-align:top;padding:6px 8px;width:50%">
      <div style="text-align:center;font-weight:700">卖方</div>
    ...
    <td style="border:1px solid #000;vertical-align:top;padding:6px 8px;width:50%">
      <div style="text-align:center;font-weight:700">买方</div>
